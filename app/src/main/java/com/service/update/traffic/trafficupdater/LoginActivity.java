...
/**
 * Created by Deathwing on 5/3/2017.
 */
...
public class LoginActivity extends AppCompatActivity {
    ...
    public static String setemail = "project@gmail.com";
    public static String setpassword = "project321";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String enteredemail = _emailText.getText().toString();
    ...
    public void login() {
        ...
        getemail = _emailText.getText().toString();
        getpassword = _passwordText.getText().toString();
